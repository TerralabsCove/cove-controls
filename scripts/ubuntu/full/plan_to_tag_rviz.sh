...
ros2 launch simple_assembly_tracking_moveit_config moveit_rviz.launch.py \
  rviz_config:="$REPO_ROOT/src/simple_assembly_tracking_moveit_config/config/plan_to_tag.rviz" \
  "$@" &
rviz_pid=$!
